...
-- Enable real-time for live sessions (skip tables already in publication)
DO $$
BEGIN
  -- Try to add live_sessions to realtime publication
  BEGIN
  ...
  -- Try to add live_session_participants to realtime publication  
  BEGIN
...
-- Set replica identity for real-time updates on live session tables
